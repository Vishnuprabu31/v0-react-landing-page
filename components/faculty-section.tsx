        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-full aspect-square mb-4 rounded-lg overflow-hidden shadow-lg border-4 border-secondary">
                <Image
              ...
              <p className="text-center text-secondary font-semibold text-sm">Expert Mentor</p>
            </div>
